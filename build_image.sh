...
# Pull docker images
docker pull ghcr.io/mark-me/music_explorer:$VERSION_ID
...
if [ "$PUSH_IMAGES" = true ]; then
    docker push ghcr.io/mark-me/music_explorer:$VERSION_ID
    docker push ghcr.io/mark-me/music_explorer:latest
fi